...
define('image-service',['exports', 'aurelia-http-client'], function (exports, _aureliaHttpClient) {
    ...
    var ImageService = exports.ImageService = function () {
        ...
        ImageService.prototype.setCurrentCollection = function setCurrentCollection(nr) {
            this.currentNr = nr;
            if (!this.collection.hasOwnProperty('collections')) this.collection = [];else this.loadCurrentStage();
        };
...
define('text!app.css', ['module'], function(module) { module.exports = "html {\n  font-size: 10px;\n  font-family: Helvetica Neue, Helvetica, Arial, sans-serif;\n  height: 100%;\n  background: linear-gradient(rgba(255, 255, 255, 0.3), rgba(255, 255, 255, 0.5)), url(\"/src/images/europa_final.jpg\");\n  background-size: cover;\n  background-attachment: fixed; }\n\nbody {\n  font-size: 12px;\n  height: 100%;\n  margin: 0; }\n\n.fade {\n  z-index: 999;\n  background: rgba(0, 0, 0, 0.01);\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0; }\n\na {\n  text-decoration: none;\n  color: forestgreen; }\n"; });
