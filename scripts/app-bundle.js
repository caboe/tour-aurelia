...
define('text!page/prolog/prolog.css', ['module'], function(module) { module.exports = ""; });
define('text!page/prolog/prolog.html', ['module'], function(module) { module.exports = "<template><div class=\"pageProlog\"><h2>${navigationService.currentPage.title}</h2><h1>${navigationService.currentPage.headline}</h1></div></template>"; });
